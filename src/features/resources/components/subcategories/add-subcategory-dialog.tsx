...
import { AddSubcategoryForm } from "@/features/resources/components/subcategories/add-subcategory-form"
import { fetcherSSR } from "@/lib/api/fetcher"
import { Category } from "@/types"

export const AddSubcategoryDialog = async () => {
  const t = await getTranslations("ResourcesSubcategoriesPage.dialog")
